...
class CrimeListFragment: Fragment() {
    ...
    inner class CrimeAdapter(val crimeEntities: List<Crime>): RecyclerView.Adapter<CrimeHolder>() {
    ...
    //интерфейс обратного вызова. Позволит передать события кликов из CrimeListFragment обратно на хост-activity.
    interface  Callbacks {
    ...
    override fun onAttach(context: Context) {
        ...
        //т.к. фрагмент размещается в активити, то контекст является экземпляром активити
...
//        сообщаем FragmentManager что экземпляр фрагмента должен получать обратные вызовы меню
